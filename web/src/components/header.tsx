            ...
            <div className="w-[100%] h-[8.1vh] flex flex-row gap-6">
                ...
                <div className=' w-[60%] h-[100%] flex flex-row justify-end items-center relative'>
                    <div className='w-[90%] h-[100%] mr-[5%] gap-8 flex flex-row items-center justify-end'>
                        ...
                        <IoSettingsOutline color='rgb(113, 113, 122)' fontSize={'1.5rem'} onClick={displaySettings} className="hover:cursor-pointer" />
                    </div>
                </div>
            </div>
            <div className=' hidden absolute h-[23vh] w-[20%] bg-[rgb(28,28,34)] flex flex-col justify-center items-center gap-3 right-8 rounded-sm'>
                <p className='text-[rgb(138,138,150)] text-xl mb-2 mt-1'>Settings</p>
                <button className='h-[25%] bg-[rgb(57,57,63)] w-[80%] border-[1px] border-solid border-zinc-500 rounded text-[rgb(138,138,150)] text-md font-sans font-semibold'>Change Theme &nbsp;&nbsp;&nbsp;
